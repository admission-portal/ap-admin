        ...
        <div className="DashboardCard__TitleChart_Container">
          <div className="DashboardCard__Title">
            ...
            <h4
              ...
              style={{
                color: isDown ? '#fe5461' : '#29cc97',
                fontFamily: 'PoppinsMedium, sans-serif',
              }}
            >
              {isDown ? (
                <DownTrend
                  style={{ color: '#fe5461', fontSize: '24px' }}
                  className="DashboardCard_graph_icon me-2"
                />
              ) : (
                <UpTrend
                  style={{ color: '#29cc97', fontSize: '24px' }}
                  className="DashboardCard_graph_icon me-2"
                />
              )}
              {value.value.value}
        ...
        <div className="DashboardCard__Number_Container">
          <div className="DashboardCard__Number_Container_inside">
            {isDown ? (
              <DownTrend
                style={{ color: '#fe5461', fontSize: '24px' }}
                className="DashboardCard_graph_icon"
              />
            ) : (
              <UpTrend
                style={{ color: '#29cc97', fontSize: '24px' }}
