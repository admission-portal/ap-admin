        ...
        <div className="DetailsOfApplication">
            ...
            <Row><Col span={24}>
                <form autoComplete="off" onSubmit={onSubmit} id="DetailForm">
                    ...
                    <br /> {<label>Application ID:</label>}<br />

                    <input
                        type="text"
                        value={Details['ApplicationID']}
                        onChange={(e) => { }} required disabled={ClickedOnEdit} />
                    ...
                    {!ClickedOnEdit && <div className="Application_btn_container">
